...
public class RsaSignatureGenerator
{
    ...
    public static void Main(string[] args)
    {
        ...
        string bootPath = radixPath + "SCAME_BOOT\\trunk\\EWARM\\BOOTSCU_GD_HW_MP28947\\Exe";
        string fwPath = pathFile + "EWARM\\TARGET_REL_HW_MP28947\\Exe";
        string srecPath = pathFile + "EWARM\\srec_cat.exe ";
        //string keyPubFileName = pathFile + "EWARM\\pubkeyEcc.pem ";
        string keyPubFileName = pathFile + "EWARM\\pubkeyEccRawTarget.bin ";
        //string keyPrivFileName = pathFile + "EWARM\\keyEcc.pem ";
        string keyPrivFileName = pathFile + "EWARM\\keyEccRawTarget.bin";
...
#if GIGADEVICE
                strBinFwFileName = fwPath + "\\SCU_GDF4xx_HW_MP28947.bin"; 
#else
            strBinFwFileName = fwPath + "\\ScameSCU.bin";
#endif
            strBinOutAllFileName = fwPath + "\\BER_ControlUnitBoot_Target_";
            strBinOutFwFileName = fwPath + "\\BER_ControlUnit_Target_";
            int cnt;
