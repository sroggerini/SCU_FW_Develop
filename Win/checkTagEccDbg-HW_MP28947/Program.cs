...
public class RsaSignatureGenerator
{
    ...
    public static void Main(string[] args)
    {
        ...
        string fwPath = pathFile + "EWARM\\TARGET_DBG_HW_MP28947\\Exe";
...
#endif
            strBinOutAllFileName = fwPath + "\\BER_ControlUnitBoot_Dbg_";
            strBinOutFwFileName = fwPath + "\\BER_ControlUnit_Dbg_";
            int cnt;
