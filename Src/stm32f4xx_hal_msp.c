...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
        ...
        PB1     ------> ADC1_IN9
        */
        GPIO_InitStruct.Pin = TA_ADC_Pin|SW_IN_ADC_Pin|TEMP_ADC_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
    
        GPIO_InitStruct.Pin = CP_ADC_Pin|IM_ADC_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
    
        GPIO_InitStruct.Pin = PP_ADC_Pin|VIN_ADC_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC0     ------> ADC3_IN10
    */
    GPIO_InitStruct.Pin = TA_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TA_ADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, TA_ADC_Pin|SW_IN_ADC_Pin|TEMP_ADC_Pin);

    HAL_GPIO_DeInit(GPIOA, CP_ADC_Pin|IM_ADC_Pin);

    HAL_GPIO_DeInit(GPIOB, PP_ADC_Pin|VIN_ADC_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC0     ------> ADC3_IN10
    */
    HAL_GPIO_DeInit(TA_ADC_GPIO_Port, TA_ADC_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    GPIO_InitStruct.Pin = LCD_V0_Pin|VOCE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
#else
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, LCD_V0_Pin|VOCE_Pin);
#else
    /**DAC GPIO Configuration
    PA4     ------> DAC_OUT1
    */
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    PB8     ------> I2C1_SCL
    */
    GPIO_InitStruct.Pin = SMB0_SDA_Pin|SMB0_SCL_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB8     ------> I2C1_SCL
    */
    HAL_GPIO_DeInit(SMB0_SDA_GPIO_Port, SMB0_SDA_Pin);

    HAL_GPIO_DeInit(SMB0_SCL_GPIO_Port, SMB0_SCL_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = DLED_A_Pin|DLED_B_Pin|DLED_C_Pin|PWM_LUM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    */
    ...
    HAL_NVIC_SetPriority(UART5_IRQn, 5, 0); // Priority high to detect always the IDLE condition
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = UART2_TX_Pin|UART2_RX_Pin;    /* Fixed SCU-31 */ 
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
