...
void HAL_ETH_MspInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = ETH_TXD1_Pin|ETH_TX_EN_Pin|ETH_TXD0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_ETH;
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE BEGIN ETH_MspDeInit 1 */
    ...
    */
    ...
    HAL_GPIO_DeInit(ETH_TXD1_GPIO_Port, ETH_TXD1_Pin|ETH_TX_EN_Pin|ETH_TXD0_Pin);
...
#else
  heth.Init.PhyAddress = KSZ8091_PHY_ADDRESS;
#endif
/* questo però è il mac address di STMicroelectronics !! */
  heth.Init.MACAddr = getMac();
...
/* USER CODE BEGIN OS_THREAD_NEW_CMSIS_RTOS_V2 */
  if (hEthIntf != NULL)
  {
    vTaskDelete(hEthIntf);
  }
  memset(&attributes, 0x0, sizeof(osThreadAttr_t));
  attributes.name = "EthIf";
  attributes.stack_size = INTERFACE_THREAD_STACK_SIZE;
  attributes.priority = osPriorityRealtime;
  hEthIntf = osThreadNew(ethernetif_input, netif, &attributes);
