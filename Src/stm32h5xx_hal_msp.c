...
void HAL_RTC_MspInit(RTC_HandleTypeDef* hrtc)
{
  ...
  */
    ...
    /* RTC interrupt Init */
    HAL_NVIC_SetPriority(TAMP_IRQn, 2, 0);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC8     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(PWM_CP_GPIO_Port, PWM_CP_Pin);

    HAL_GPIO_DeInit(VAC230_DET_GPIO_Port, VAC230_DET_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA12     ------> USART1_DE
    */
    GPIO_InitStruct.Pin = USART1_TX_Pin|USART1_DE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    */
    ...
    handle_GPDMA2_Channel5.Init.Request = GPDMA2_REQUEST_USART6_TX;
    ...
    __HAL_LINKDMA(huart, hdmatx, handle_GPDMA2_Channel5);
    ...
    handle_GPDMA2_Channel2.Init.Request = GPDMA2_REQUEST_USART6_RX;
    ...
    __HAL_LINKDMA(huart, hdmarx, handle_GPDMA2_Channel2);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(PRG_TX_GPIO_Port, PRG_TX_Pin);

    HAL_GPIO_DeInit(PRG_RX_GPIO_Port, PRG_RX_Pin);
