...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = TA1TYPE_Pin|VIN_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE BEGIN TIM9_MspInit 1 */
    ...
    */
    ...
    /* NOTE: at the moment configure the pin as stardard output, since the pwm 
             output starts when the contactor need to beactivated             */
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = DLED_A_Pin|DLED_B_Pin|DLED_C_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
