...
int32_t BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  ...
  if (ButtonMode == BUTTON_MODE_EXTI)
  {
	...
	else
    {
      ...
      HAL_NVIC_SetPriority((BUTTON_IRQn[Button]), BSP_BUTTON_PRIO[Button], 0x09);
...
static void BUTTON_USER_GPIO_Init(void) {
  ...
  HAL_NVIC_SetPriority(USER_BUTTON_EXTI_IRQn, 10, 10);
...
#if (USE_BSP_COM_FEATURE > 0) /*** eliminato by Nik */
