...
__weak HAL_StatusTypeDef MX_SPI1_Init(SPI_HandleTypeDef* hspi)
{
  ...
  hspi->Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_128; //SPI_BAUDRATEPRESCALER_16;
...
#ifdef STM32F746xx
  /** RST = PB14 = SBC_PWR, IRQ = PE12 = IN8, SPI1_CLK = PB3, SPI1_MISO = PB4, SPI1_MOSI = PB5, SPI1_CS = PA15 */
