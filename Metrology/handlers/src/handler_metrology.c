...
const nvmLeg_t metroDefaultNvm = {
  ...
  {               // powerFact[NUM_SENSOR_TYPE][4]
    ...
    /* for current sensor type --> EM_TA_ITA_SBT002  */
    25757906,     // ch 1  
    25757906,     // ch 2
    25757906,     // ch 3
    25757906,     // ch 4

    /* for current sensor type --> EM_TA_ITA_SBT012  */
    13619514,     // ch 1  
    13619514,     // ch 2
    13619514,     // ch 3
    13619514,     // ch 4
    
    /* for current sensor type --> EM_TA_HON_HMCT406  */
    25757906,     // ch 1  
    25757906,     // ch 2
    25757906,     // ch 3
    25757906,     // ch 4
    
    /* for current sensor type --> EM_TA_SCT_10_1_200TS  */
    25560400,     // ch 1  
    25560400,     // ch 2
    25560400,     // ch 3
    25560400,     // ch 4
  ...
  EM_SCAME_DEFAULT_BAUDRATE | (EM_TA_ITA_SBT002 << EM_CURRSENS_CONFIG_BIT_POS),  /* Configuration */
};
...
EM_CurrSens_type_e EM_CurrSens_T1_type;
EM_CurrSens_type_e EM_CurrSens_T23_type;
