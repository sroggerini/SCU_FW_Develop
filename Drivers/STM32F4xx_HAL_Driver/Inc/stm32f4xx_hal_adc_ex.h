...
#ifdef GD32F4xx                                                 /* NOTE: Modified to fit with GD32F4xx */
#define ADC_CHANNEL_TEMPSENSOR  ((uint32_t)ADC_CHANNEL_16)      /* NOTE: Modified to fit with GD32F4xx */
#else                                                           /* NOTE: Modified to fit with GD32F4xx */
